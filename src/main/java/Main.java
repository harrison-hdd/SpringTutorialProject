...
//        StudentDAOImpl studentDAO = (StudentDAOImpl) context.getBean("studentDAOImpl");
        ...
        //BeanPropertyRowMapper maps each field in a row of the query result to the student object.
        //what if table columns and class data members have different names?
